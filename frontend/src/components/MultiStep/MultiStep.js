    ...
    return (
        <div className=' flex flex-wrap justify-center items-center w-full  m-auto border-b border-b-gray-200'>
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative '>
                <div>
                    <div onClick={() => onStepChange(0)}  className={'bg-white transition-all z-50 relative  h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(0) || stepNum == 0 ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        {
                            isCompleted(0) ?
                ...
                <div className=' md:flex justify-center items-center absolute top-10 -right-12 pl-5 z-0'>
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative'>
                <div>
                    <div onClick={() => onStepChange(1)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(1) || stepNum == 1 ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        {
                            isCompleted(1) ? 
                                <i className="material-icons likes-icon text-white text-base" >check</i>
                            :
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs relative'>
                <div>
                    <div  onClick={() => onStepChange(2)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm  hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(2) || stepNum == 2  ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        {
                            isCompleted(2) ? 
                                <i className="material-icons likes-icon text-white text-base" >check</i>
                            :
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative'>
                <div>
                    <div  onClick={() => onStepChange(3)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(3) || stepNum == 3  ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        4
                    </div>
                </div>
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative'>
                <div>
                    <div  onClick={() => onStepChange(4)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(4) || stepNum == 4  ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        5
                    </div>
                </div>
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative'>
                <div>
                    <div  onClick={() => onStepChange(5)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(5) || stepNum == 5  ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        6
                    </div>
                </div>
            ...
            <div className='w-1/2 p-5 md:w-1/7 flex flex-col gap-3 justify-center items-center  text-xs  relative'>
                <div>
                    <div  onClick={() => onStepChange(6)}  className={'bg-white transition-all z-50 relative h-10 w-10 border  rounded-full flex justify-center items-center text-white  text-sm hover:bg-blue-600 hover:text-white cursor-pointer hover:border-0 ' + (isCompleted(6) || stepNum == 6 ? 'bg-blue-600 text-white' : 'border border-blue-600 text-blue-500 ')}>
                        7
                    </div>
                </div>
